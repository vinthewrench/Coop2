...
const uint8_t CMDBUFFER_CHAR_CNTLU     = 0x15;

extern const char*  CMDBUFFER_STR_PROMPT;
  ...
  public:
    ...
    CmdBufferObject()
        : m_endChar(CMDBUFFER_CHAR_LF),
          ...
          m_clearChar(CMDBUFFER_CHAR_CNTLU),
          m_promptStr(CMDBUFFER_STR_PROMPT),
           m_dataOffset(0),
          m_echo(false)
    {
    }
    ...
    bool readSerialChar(Stream *serial);
	 ...
	 void displayPrompt(Stream *serial);
